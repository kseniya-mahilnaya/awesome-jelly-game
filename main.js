...
PlayState._createHud = function () {
    ...
    let starIcon = this.game.make.image(this.keyIcon.width + 795, 0, 'icon:star');
...
PlayState._createHudHeart = function () {
    ...
    this.heartFont = this.game.add.retroFont('font:numbers', 20, 30,
        NUMBERS_STR, 6);
    let heartIcon = this.game.make.image(34 + 707, 5, 'icon:heart');
    let heartScoreImg = this.game.make.image(heartIcon.x + heartIcon.width + 5,
        20, this.heartFont);
